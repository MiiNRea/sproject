#pragma checksum "c:\Users\MiiNRea\Desktop\sproject1\Views\PurchaseOrder\Create.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9e26a22d25492c37fc7df27a5d56c27f9ab75ac3"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9e26a22d25492c37fc7df27a5d56c27f9ab75ac3", @"/Views/PurchaseOrder/Create.cshtml")]
 ...
 <div class=""row"">
     <div class=""col-md-6"">
         <div class=""form-group"">
             ...
             <select id=""product_names"" ></select>
         </div>
         <div class=""form-group"">
             <label class=""control-label"">supplier </label>
             <select id=""supplier_names"" ></select>
         </div>
        <h5>Product info</h5>
         ...
         <div class=""form-group"">
             Quantity <input id=""txt_qty""></input>
 ...
 <div>
     ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9e26a22d25492c37fc7df27a5d56c27f9ab75ac35440", async() => {
 ...
 <script>
     ...
     function updateTable() {
         ...
         var total = 0;
         for (var i = 0; i < cart.length; i++) {
             var row = tr(td(cart[i].id)+td(cart[i].name) + td(cart[i].suppli");
                WriteLiteral(@"er_id)+ td(cart[i].qty) + td(cart[i].price) + td(cart[i].total) + td(button(cart[i]
                 .id, ""remove"")));
    ...
    function cb_show_productinfo(){
        ...
        var found2 = list.find(function(b){
         ...
         var pr");
                WriteLiteral(@"oduct_series = found2.product_series;

#pragma checksum "C:\Users\MiiNRea\Desktop\sproject\Views\PurchaseOrder\Create.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "cbf513a3e13779849af18438ee418cbea24ac675"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"cbf513a3e13779849af18438ee418cbea24ac675", @"/Views/PurchaseOrder/Create.cshtml")]
     ...
     <div class=""col-md-6"">
        ...
        <h5>Product info</h5>
         ...
         <table class=""table"" id=""table1"">
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "cbf513a3e13779849af18438ee418cbea24ac6755811", async() => {
 ...
 <script>
   ...
   ");
     ...
     function updateTable() {
         ...
         var selling_price = 0;
  ");
                WriteLiteral(@"       for (var i = 0; i < cart.length; i++) {
     ...
     function product_data_arrived(data) {
         ...
         $.each(unique_product_names, function (key, item) {
             cmb_product_names.append('<option value=' + item + '>' + item + '</opt");
                WriteLiteral(@"ion>');
         });
        if(list.length>0){
    ...
    function cb_show_productinfo(){
        ...
        function showtable(){
         //remove all rows except the header row
         ");
                WriteLiteral(@"tbl_table2.find(""tr:gt(0)"").remove();
         //tbl_table2.empty();
